                  ...
                  !props.canReadWrite ? 
                    <HCTooltip text="Delete" id="delete-tooltip" placement="bottom">
                      <i aria-label="icon: delete">
                        <FontAwesomeIcon icon={faTrashAlt} className={styles.deleteIcon} size="lg"  data-testid={elem.name+"-delete666"} onClick={() => handleCardDelete(elem.name)}/>
                      </i>
                    </HCTooltip> : 
                    <HCTooltip text={"Delete: " + SecurityTooltips.missingPermission} id="delete-tooltip" placement="bottom" >
                      <i data-testid={elem.name+"-disabled-delete555"}>
