  ...
  return (
    <div id="sidePanel" className={styles.sidePanel}>
      <div>
        ...
        <span><HCTooltip text={ModelingTooltips.deleteIcon} id="delete-tooltip" placement="top">
          <i key="last" role="delete-entity button" data-tes1id={modelingOptions.selectedEntity + "-delete"} onClick={(event) => {
